...
@Description("Represenst one of more likelihoods which represent the " +
...
public class Likelihood extends CompoundDistribution {
	...
	void collectDataNodes(Plugin plugin, Set<DataNode> DataNodes) throws Exception {
		for (Plugin o : plugin.listActivePlugins()) {
